...
import couchbase_v2._bootstrap
import couchbase._libcouchbase as _LCB
from couchbase_v2 import Bucket as _Base
...
from couchbase_v2 import make_dvpath, make_options_string
from couchbase_v2 import View
from couchbase_v2 import N1QLQuery, N1QLRequest
...
import json
from couchbase_v2 import AnalyticsRequest, AnalyticsQuery
from couchbase_v2 import ConnectionString
import couchbase_v2.result
from typing import *
...
class Bucket(_Base):
    ...
    def encrypt_fields(self, document, fieldspec, prefix):
        ...
        if not encrypted_string:
            raise couchbase_c2.exceptions.CouchbaseError("Encryption failed")
    ...
    def decrypt_fields_real(self, document, *args):
        ...
        if not decrypted_string:
            raise couchbase_c2.exceptions.CouchbaseError("Decryption failed")
