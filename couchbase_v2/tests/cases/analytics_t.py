...
from couchbase_v2.tests.base import RealServerTestCase, ConnectionTestCase, version_to_tuple
...
import traceback
from couchbase_v2.tests.base import PYCBC_SERVER_VERSION
import os


analytics_dir = os.path.join("couchbase_v2", "tests", "cases", "analytics")
