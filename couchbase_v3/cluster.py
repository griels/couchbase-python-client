...
from couchbase_v2 import OptionBlock, Bucket, forward_args, OptionBlockDeriv
from couchbase_v2 import BucketOptions
...
class Cluster:
    ...
    def __init__(self,
        ...
        self._cluster = SDK2Cluster(connection_string, **couchbasethree.v3.forward_args(None, *options))
