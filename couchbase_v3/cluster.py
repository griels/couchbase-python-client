...
from couchbase_v3 import OptionBlock, Bucket, forward_args, OptionBlockDeriv
from couchbase_v3.bucket import BucketOptions
from couchbase_v2 import Cluster as SDK2Cluster, Authenticator as SDK2Authenticator
...
class Cluster:
    ...
    def __init__(self,
        ...
        self._cluster = SDK2Cluster(connection_string, **couchbase_v3.forward_args(None, *options))
