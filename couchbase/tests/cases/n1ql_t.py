...
from couchbase.tests.base import MockTestCase, CouchbaseTestCase, ConnectionTestCase
...
class N1QLReal(ConnectionTestCase):
    ...
    def test_trivial_query(self):
       ...
       # result1=(self.cb.n1ql_query("SELECT * FROM `default` "))

        result2=(self.cb.n1ql_query("SELECT * FROM `beer-sample` "))
