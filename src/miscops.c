    ...
    int argopts)
{
    ...
    pycbc_DURABILITY_LEVEL durability_level = LCB_DURABILITYLEVEL_MAJORITY_AND_PERSIST_ON_MASTER;
    struct pycbc_common_vars cv = PYCBC_COMMON_VARS_STATIC_INIT;

    static char *kwlist[] = {
            "keys", "cas", "quiet", "persist_to", "replicate_to", "durability_level", NULL
    };
