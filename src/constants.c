...
#define X(NAME,TYPE)\
    {\
        ...
        pycbc_replace_str(&as_words, "threshold", "threshold for");\
        pycbc_replace_str(&as_words, "n1ql", "N1QL");\
        pycbc_replace_str(&as_words, "kv", "KV");\
        pycbc_replace_str(&as_words, "fts", "FTS");\
