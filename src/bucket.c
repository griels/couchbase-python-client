...
Bucket_encrypt_fields(pycbc_Bucket *self, PyObject *args)
{
    ...
    if (!PyErr_Occurred()) {
        ...
        result = NULL;
        PYCBC_EXC_WRAP(
                LCB_ERRTYPE_INTERNAL, LCB_ERRTYPE_INTERNAL, "Not on V4 yet");
        goto FINISH;
                                           ...
                                           pycbc_coll_res_t *result)
{
    ...
    PYCBC_DEBUG_LOG("Trying to get CID for %.*s",
                                       ...
                                       PyObject *kwargs)
{
    ...
    self->collection.collection =
            pycbc_strn_from_managed(PyDict_GetItemString(kwargs, "collection"));
    self->collection.scope =
            pycbc_strn_from_managed(PyDict_GetItemString(kwargs, "scope"));
                                               ...
                                               PyObject *kwargs)
{
    ...
    // PYCBC_XINCREF(result);
    return result;
    //    return (pycbc_Collection *) PYCBC_TYPE_CTOR(&pycbc_CollectionType,
    //    args, kwargs);
}
#endif
#ifdef PYCBC_COLLECTIONS_PROPER
...
static PyGetSetDef Collection_TABLE_getset[] = {
        {"cid", (getter)Collection_get_cid, NULL, PyDoc_STR("Bucket CID")},
        {NULL}};
