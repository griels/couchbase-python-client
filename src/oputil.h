...
#define PYCBC_OPUTIL_CONTEXT_Collection pycbc_oputil_keyhandler_raw_Bucket* original,

#define PYCBC_OPUTIL_KEYHANDLER_RAW(UNIT)\
typedef int (*pycbc_oputil_keyhandler_raw_##UNIT)\
        (\
         PYCBC_OPUTIL_CONTEXT_##UNIT\
         pycbc_##UNIT *self,\
...
typedef int(*pycbc_oputil_keyhandler_raw_Bucket)(pycbc_Bucket *self, struct pycbc_common_vars *cv, int optype,
                                                 PyObject *key, PyObject *value, PyObject *options, pycbc_Item *item,
                                                 void *arg, pycbc_stack_context_handle context);

typedef int(*pycbc_oputil_keyhandler_raw_Collection)(pycbc_oputil_keyhandler_raw_Bucket *original,
                                                     pycbc_Collection *self, struct pycbc_common_vars *cv, int optype,
...
#define PYCBC_OPUTIL_EXTRA_Collection const pycbc_oputil_keyhandler_raw_Bucket* original;
...
pycbc_oputil_keyhandler_##UNIT pycbc_oputil_keyhandler_build_##UNIT(pycbc_oputil_keyhandler_raw_##UNIT cb, const char* category, const char* name);
...
PYCBC_UNITS(PYCBC_OPUTIL_KEYHANDLER_BUILD_DECL)
#endif
#define PYCBC_OPUTIL_KEYHANDLER_BUILD(UNIT,NAME) pycbc_oputil_keyhandler_build_##UNIT(NAME, NAME##_category(), #NAME)
#define PYCBC_OPUTIL_ITER_MULTI_BASE(UNIT,SELF,SEQTYPE,COLLECTION,CV,OPTYPE,HANDLER,CONTEXT,...)\
    pycbc_oputil_iter_multi_##UNIT(SELF,SEQTYPE,COLLECTION,CV,OPTYPE,PYCBC_OPUTIL_KEYHANDLER_BUILD(UNIT,HANDLER),CONTEXT,__VA_ARGS__)
#define PYCBC_OPUTIL_ITER_MULTI(SELF,SEQTYPE,COLLECTION,CV,OPTYPE,HANDLER,CONTEXT,...)\
    PYCBC_OPUTIL_ITER_MULTI_BASE(Bucket,SELF,SEQTYPE,COLLECTION,CV,OPTYPE,HANDLER,CONTEXT,__VA_ARGS__)
#else
 ...
 * on error.
 */
int pycbc_handle_durability_args(pycbc_Bucket *self, pycbc_dur_params *params, char persist_to, char replicate_to,
