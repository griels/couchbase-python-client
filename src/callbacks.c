...
static void health_callback(lcb_t instance,
                            int cbtype,
                            const lcb_RESPBASE *resp_base, const void *cookie, const lcb_CMDHEALTH *cmd)
{
    pycbc_Bucket *parent;
    const lcb_RESPHEALTH *resp = (const lcb_RESPHEALTH *)resp_base;
    int do_return = 0;
