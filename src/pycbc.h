...
#define PYCBC_DECREF(X)   Py_XDECREF(X)
...
#define PYCBC_TRACING_POP_CONTEXT(CONTEXT) pycbc_Context_finish(CONTEXT);

#define WRAP_TOPLEVEL_WITHNAME(RV, CATEGORY, NAME, TRACER, STRINGNAME, ...) \
{\
